...
import com.mb.fhl.R;
import com.mb.fhl.common.MPChartMarkerView;
import com.mb.fhl.common.MyValueFormatter;
import com.mb.fhl.common.StringAxisValueFormatter;
...
public class MPChartHelper {
    ...
    private static void setBarChartData(BarChart barChart, List<Float> yAxisValue, String title, Integer barColor) {
        ...
        if (barChart.getData() != null && barChart.getData().getDataSetCount() > 0) {
            ...
            if (barColor == null) {
                set1.setColor(ContextCompat.getColor(barChart.getContext(), R.color.color_4e76e5));//设置set1的柱的颜色
            } else {
    ...
    private static void setThreeBarChartData(BarChart barChart, List<Integer> xAxisValue, List<Float> yAxisValue1, List<Float> yAxisValue2, List<Float> yAxisValue3, String bartilte1, String bartitle2, String bartitle3) {
        ...
        if (barChart.getData() != null && barChart.getData().getDataSetCount() > 0) {
            ...
            first_set.setColor(ContextCompat.getColor(barChart.getContext(), R.color.color_4e76e5));
            second_set.setColor(ContextCompat.getColor(barChart.getContext(), R.color.color_3077b5));
            third_set.setColor(ContextCompat.getColor(barChart.getContext(), R.color.color_e94d4e));
    ...
    public static void setLinesChart(LineChart lineChart, List<String> xAxisValue, List<List<Float>> yXAxisValues, List<String> titles, boolean showSetValues, int[] lineColors) {
        ...
        lineChart.animateX(800);//数据显示动画，从左往右依次显示
    }
